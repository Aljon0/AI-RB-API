...
// Middleware
app.use(cors({ 
  origin: ['http://localhost:5173', 'http://localhost:5000','https://ai-rb-haee.onrender.com','https://ai-rb-api.onrender.com' ] // Allow both Vite dev server and potential React dev server
}));
